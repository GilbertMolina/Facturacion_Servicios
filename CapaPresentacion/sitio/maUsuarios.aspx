<%@ Page Title="Mantenimiento Usuarios" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/ServiciosABCSuperAdmin.Master" CodeBehind="maUsuarios.aspx.vb" Inherits="CapaPresentacion.maUsuarios" %>
		...
		<div class="col-xs-9 col-sm-9 col-md-6">
			<div class="panel panel-default">
				<div class="panel-body">
					<fieldset>
						<legend class="text-center">Mantenimiento Usuarios</legend>
                        <div class="col-xs-12">
							...
							<div class="row">	
								<div class="col-xs-6">
									<div class="row">
										...
										<div class="col-xs-8">
                                            <asp:HyperLink ID="hlRegresar" class="btn btn-back" runat="server" NavigateUrl="listadoUsuarios.aspx">Regresar</asp:HyperLink>
										</div>
										<div class="col-xs-2"></div>
									</div>
								</div>
