...
#Region "Métodos de la pagina"
    ...
    Protected Sub cargarDropDownListRol()
        ddlRol.Items.Clear()
        ddlRol.Items.Add(New ListItem("Super Administrador", 1))
        ddlRol.Items.Add(New ListItem("Administrador", 2))
        ddlRol.Items.Add(New ListItem("Agente de cobros registro facturas", 3))
        ddlRol.Items.Add(New ListItem("Agente de cobros registro recibos", 4))
        ddlRol.Items.Add(New ListItem("Encargado seguimiento de cobros", 5))
