<%@ Page Title="Registrar usuario" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/ServiciosABCDefault.Master" CodeBehind="registrar_usuario.aspx.vb" Inherits="CapaPresentacion.registrar_usuario" %>
					...
					<fieldset>
						...
						<form action="#" role="form" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
                                    <asp:TextBox ID="txtTelefono" class="form-control" placeholder="Tel&eacute;fono" runat="server"></asp:TextBox>
									<br />
								</div>
							</div>
							<br />
							...
							<div class="form-group">
								...
								<div class="col-xs-7">
                                    <asp:TextBox ID="txtContraseña" class="form-control" placeholder="Contraseña" 
                                        runat="server" TextMode="Password" MaxLength="30"></asp:TextBox>
									<br />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-7">
                                    <asp:TextBox ID="txtContraseñaConfirmar" class="form-control" 
                                        placeholder="Confirmar contraseña" runat="server" TextMode="Password" 
                                        MaxLength="30"></asp:TextBox>
									<br />
								</div>
							</div>
							<div class="form-group">
								<label for="ddlRol" class="control-label col-xs-5 text-right">Rol asignado: </label>
								<div class="col-xs-7">
									<asp:DropDownList ID="ddlRol" class="form-control" runat="server" disabled></asp:DropDownList>
									<br />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-7">
									<asp:DropDownList ID="ddlEstado" class="form-control" runat="server" disabled></asp:DropDownList>
									<br />
								</div>
							</div>
							<br />
							<div class="row">	
								...
								<div class="col-xs-6 text-right">
                                    ...
                                    <asp:Button ID="btnRegistrar" class="btn btn-success" runat="server" 
                                        Text="Registrar" />&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
							</div>
						</form>
