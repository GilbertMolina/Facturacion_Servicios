<%@ Page Title="Lista de Clientes" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/ServiciosABCSuperAdmin.Master" CodeBehind="listadoClientes.aspx.vb" Inherits="CapaPresentacion.listadoClientes" %>
		...
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<fieldset>
						<legend class="text-center">Lista de Clientes</legend>
						<div class="col-xs-12">
					    ...
					    <div class="row">
						    <div class="col-xs-12 text-right">
							    <asp:ImageButton ID="imgbtnAgregar" runat="server" ImageUrl="~/includes/images/ico-agregar.png" ToolTip="Agregar un nuevo cliente" />
						    </div>
					    </div>
                        <asp:UpdatePanel ID="updatePanelListaClientes" runat="server">
                            <ContentTemplate>
					            <div class="row">
						            <div class="col-xs-12">
							            ...
							            <div class="table-responsive">
								            <asp:GridView ID="grdListaClientes" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" AllowPaging="True" PageSize="5">
