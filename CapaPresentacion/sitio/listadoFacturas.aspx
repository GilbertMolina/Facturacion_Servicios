<%@ Page Title="Lista de Facturas" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/ServiciosABCAdmin.Master" CodeBehind="listadoFacturas.aspx.vb" Inherits="CapaPresentacion.listadoFacturas" %>
		...
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<fieldset>
						<legend class="text-center">Lista de Facturas Nuevas</legend>
						<div class="col-xs-12">
						            ...
						            <div class="col-xs-12">
							            ...
							            <div class="table-responsive">
								            ...
								            <Columns>
								                ...
								                <asp:ButtonField CommandName="Imprimir" Text="&lt;img alt=&quot;Imprimir&quot; src=&quot;../includes/images/ico-imprimir.png&quot; /&gt;" >
								                    <HeaderStyle CssClass="headerText-table" />
							                    </asp:ButtonField>
								                <asp:ButtonField CommandName="Modificar" Text="&lt;img alt=&quot;Modificar&quot; src=&quot;../includes/images/ico-modificar.png&quot; /&gt;" >
								                    <HeaderStyle CssClass="headerText-table" />
							                    </asp:ButtonField>
